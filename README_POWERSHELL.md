...
**Русский:**
1. **Генерация тестовых файлов**: Создание 100 файлов случайных размеров во временной директории
2. **Пакетная загрузка**: Загрузка файлов пакетами по `$batchSize`
3. **Пакетное скачивание**: Скачивание тех же файлов пакетами
4. **Удалить все**: Удаление всех файлов из S3 бакета
5. **Повтор**: Ожидание 15 секунд и начало заново
