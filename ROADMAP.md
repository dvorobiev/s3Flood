...
- [ ] **Наглядное отображение итоговых CSV метрик.**
  ...
  **Как планируем реализовать:**
  ...
  - **Интерактивный анализ:**
    - Фильтрация по типу операции, статусу, размеру файла
    - Сортировка по любому столбцу
    - Группировка операций по временным интервалам
    - Выделение аномалий (операции с очень низкой/высокой скоростью или ошибками)
