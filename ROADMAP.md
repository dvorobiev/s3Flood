...
- [ ] **Удобный редактор конфигов прямо в меню.**
  ...
  **Подзадачи:**
  ...
  - [x] Подсветка изменённых значений и цветовые акценты для текущих параметров.
  - [ ] Подсветка обязательных/проблемных полей и быстрые подсказки.
  - [ ] Горячие клавиши (например, `s` — сохранить, `q` — выйти без сохранения).
  ...
  - [ ] Унификация создания/редактирования: мастер создания конфига использует тот же построчный редактор (дефолтное состояние + сохранение в файл).
